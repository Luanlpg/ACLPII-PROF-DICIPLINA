class Professor:
    ...
    def disciplinaGet (self):
        return Disciplina.nomedcpGet#(NÃO ESTOU CONSEGUINDO PUXAR A DICIPLINA DA CLASSE DICIPLINA PELA CLASSE PROFESSOR!)
...
#-------------------------------------------------------------------------------
'''nome = str('Luan Nascimento Barbosa Santos')
email = str('luanlpg13@gmail.com')
ra = str('1701387')
celular = int(11964658699)
carg_hor = int(27)
nomedcp = str('Física')
valor = float(50)'''
